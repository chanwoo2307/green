...
# ╔═╡ 3c21e32c-9231-48c9-8b58-d9c368f73a62
md" Jupyter = Julia + Python + R의 느낌"

# ╔═╡ 6d8fef1d-d449-440d-a0cb-31f6021c48ba
md"줄리아 터미널을 키고 키보드의 ]을 누르면 패키지를 다운받을 수 있는 상태가 됨"

# ╔═╡ 850dac84-ea40-45b0-a099-167eec803716
md"? 을 누르면 도움말을 알 수 있는 상태가 됨"

# ╔═╡ 088eb956-fcdb-4ad3-92bd-46b0ea0b6b34
md"### 줄리아를 실행해보자"

# ╔═╡ 46a202e6-d9f5-436f-8c7a-915fb6dc32c8
md"1. Julia를 실행한다."

# ╔═╡ c60c612f-7d35-443a-8b4e-bcb565e49d69
...
# ╔═╡ 87f67220-2e90-465b-bd38-4d4d108c5582


# ╔═╡ a7123809-2e9d-465a-9881-37a97ae9c567


# ╔═╡ 15346829-e670-4756-bb5b-d58bfcac8b56


# ╔═╡ f38da6f9-e907-4687-80dd-518c997545f0
...
@bind grade3 Select(["1학년"=>"1grade","2학년"=>"2grade","3학년"=>"3grade","4학년"=>"4grade"])

# ╔═╡ 45fe7c20-059e-4522-9eb0-923dd413fa03
grade3

# ╔═╡ 4973dc3a-694c-4643-a7b5-f736c7836bf5
md"### 다중선택"

# ╔═╡ a4a4b675-1be8-4145-80c6-c6c8d98d62ea
@bind study MultiSelect(["윈도우프로그래밍","통계데이터베이스","통계적추론","통계전산"],default=["통계전산"])

# ╔═╡ 8e39ffbd-c577-417e-8250-d182b8ac59b5
study

# ╔═╡ 82301f3f-5459-43df-abc4-840b01240eaf
md"##### 슬라이더($\star$)"

# ╔═╡ 356502e3-9ecd-4e79-8e9e-2d97b9e0bd30
@bind value1 Slider(50:100)
...
# ╔═╡ 63d6d4f2-9859-48c3-8265-dd0787b5af5d
md"$ax^2+bx+c=0,\quad x=\frac{-b \pm \sqrt{b^2-4ac}}{2a}$"

# ╔═╡ 2ae63b63-3487-4f0f-87a4-a6808c1d373d


# ╔═╡ c810af8a-4215-4508-8cbf-aa8063b9c14e
@bind a Slider(0:10, show_value=true, default=1) 

# ╔═╡ 0f4b81b6-e238-4ce4-9382-bdfaa5e8656f
@bind b Slider(0:10, show_value=true,default=3)

# ╔═╡ 05f3ad56-a6c6-4f7f-aefd-6b1c4fcc49ef
b

# ╔═╡ 78770d13-cb6e-4366-be39-70813805af9a
@bind c Slider(0:10, show_value=true,default=2)

# ╔═╡ 68e8b6ca-c1b4-45ae-a7c0-33f7609b4f13
(-b - √(b^2-4a*c) ) / 2a #근이 두개인데 하나만 출력된다.

# ╔═╡ ce574d83-8634-49ea-b863-e5c5e2d0e513
(-b - √(b^2-4a*c) ) / 2a ,(-b - √(b^2-4a*c) ) / 2a #질문

# ╔═╡ 7540418b-7acf-4193-a078-aeb5f62e6d93
md"#### 색깔선택"
